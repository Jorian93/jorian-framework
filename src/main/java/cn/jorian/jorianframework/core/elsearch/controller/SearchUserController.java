...
public class SearchUserController {
     ...
     * @return
     */
    @GetMapping("/user/select/{q}")
    @ApiOperation(value = "搜索one")
    public ResponseResult searchOne(@PathVariable @ApiParam("查询字段") String q) {
        return new ResponseResult(ResponseCode.SUCCESS,searchUserService.searchOne(q));
    }
    ...
    public ResponseResult searchAll(){
        return new ResponseResult(ResponseCode.SUCCESS,searchUserService.searchAll());
    }
